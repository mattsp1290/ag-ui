...
- **[@ag-ui/svelte](https://github.com/ag-ui-protocol/ag-ui/tree/main/integrations/community/svelte/typescript)** - Svelte integration with reactive stores for building agent-powered UIs.
