...
// ProtobufCodec implements the simplified Codec interface for Protocol Buffer encoding/decoding
...
// StreamingProtobufCodec implements the simplified StreamCodec interface for Protocol Buffer format
